blog1 = Blog.create(title: "Why I Joined a Coding Bootcamp", link: "https://medium.com/@melissafunk85/why-i-joined-a-coding-bootcamp-46931e5f0b72", image: "https://miro.medium.com/max/700/1*_1xUMTrBKrDN3uYChEb7sA.jpeg", minutes: 5)
blog2 = Blog.create(title: "Changing Images Using Hover in CSS", link: "https://medium.com/@melissafunk85/changing-images-using-hover-97af51c0d8d0", image: "https://miro.medium.com/max/700/1*whMuSZ_AlAQx1KSVVG9p3g.png", minutes: 4)
blog3 = Blog.create(title: "Planning a Coding Project", link: "https://medium.com/@melissafunk85/planning-a-coding-project-bc8f59d01c07", image: "https://miro.medium.com/max/700/1*Zu_PI_sUWu0x1r0d6MeFPQ.png", minutes: 4)
blog4 = Blog.create(title: "JavaScript Array Methods", link: "https://medium.com/@melissafunk85/javascript-array-methods-2783698cd501", image: "https://miro.medium.com/max/700/1*F4P7fHCcyHWjtMoGb8onRw.png", minutes: 4)
